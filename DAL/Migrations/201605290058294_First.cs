namespace DAL.Migrations
{
    ...
    public partial class First : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.SolutionQuestions", new[] { "SolutionId" });
            DropIndex("dbo.SolutionQuestions", new[] { "QuestionId" });
            DropIndex("dbo.SolutionAnswers", new[] { "SolutionId" });
            ...
            DropTable("dbo.SolutionQuestions");
